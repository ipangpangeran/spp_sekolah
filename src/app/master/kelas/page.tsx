...
import { GraduationCap, Plus, Users, X, Upload, Download, FileSpreadsheet } from 'lucide-react';
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/master/kelas', {
        ...
        body: JSON.stringify({ namaKelas, keterangan }),
      });
